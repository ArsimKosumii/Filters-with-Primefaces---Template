...
public class Dao implements Serializable {
	...
	public User findUserByUsernameAndPassword(String username, String password) {
		...
		Predicate sameUsername = cb.equal(user.get("username"), username);
		Predicate samePassword = cb.equal(user.get("password"), password);
		Predicate finalResult = cb.and(sameUsername, samePassword);
		criteria.where(finalResult);
	...
	public List<User> getUsers() {
		...
		criteria.select(root).where(cb.equal(root.get("role"), "user"));
